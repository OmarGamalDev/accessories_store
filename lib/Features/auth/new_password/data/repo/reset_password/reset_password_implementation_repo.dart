...
class RestPasswordImplementationRepo implements ResetPasswordRepo{
  ...
  @override
  Future<Either<Failure, String>> resetPassword({required String email, required String password, required String otp}) async{
    try{
      final response = await apiConsumer.post(EndPoint.resetPassword,data: {
        "email":email,
        "otp":otp,
